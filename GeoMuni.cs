...
namespace MunicipiosAragon
{
  ...
  class GeoMuni
  {
     ...
     * en Aragón, adquiere los datos desde el archivo binario .dat y los
     ...
     */
    private string pathGeoMuni = Directory.GetCurrentDirectory() + @"\\MunicipiosAragon.dat";
